...
},{}],"components/fields/ShowpadAsset.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    fetchBySlug: function fetchBySlug() {
      var _this = this;

      if (this.url) {
        this.error = null;
        this.loading = true;
        var slug = this.url.replace('showpad://file/', '');
        this.$api.get('/showpad/asset-slug/' + slug).then(function (data) {
          console.log(data);

          _this.fetchById(data.response.items[0].id);
...
exports.default = _default;
  ...
  return _c(
    "k-grid",
    { staticClass: "showpad-asset-field-grid" },
    [
      _c(
        "k-column",
        { attrs: { width: "5/6" } },
      ...
      _c(
        ...
        { attrs: { width: "1/6" } },
        [
          _c("k-headline", [_vm._v(" ")]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "showpad-asset-field" },
            [
              _c("k-button", {
                domProps: { innerHTML: _vm._s("Fetch") },
                on: { click: _vm.fetchBySlug }
              }),
              _vm._v(" "),
              _vm.loading
                ? _c("k-icon", {
                    staticClass: "spin",
                    attrs: { type: "loader", size: "small" }
                  })
                : _vm._e(),
              _vm._v(" "),
              _vm.url && !_vm.loading
      ...
      _c(
        ...
        [
          _c("k-info-field", {
            ...
            attrs: { theme: "negative", text: _vm.error }
          })
        ],
        1
      )
